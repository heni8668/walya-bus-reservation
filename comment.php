...
<form onsubmit='return formValidator()' action="commentphp.php" method="post" target="iframe1"  name="contact_form" target="iframe1">
...
?>
        ...
        <tr><td colspan="2" style="color: black" align="center">
        	<b>You Can Give Your Comment Here !!!</b>
        </td></tr>

            <tr>
	        <td align=right style="color:black"><label for="name">Name:</label></td>
            <td align=left><input style="width: 190px;height:35; color: blue; font-size: 15px; border-radius: 5px;" type="text" placeholder="Type Your Name"  id='name'   required name="name"/></td>
			</tr>
			
              <tr>
	        <td align=right style="color:black"><label for="name">Email:</label></td>
		 ...
		 <tr>
		       <td style="color:black" align="right" valign="top"><label>Your Comment:</label></td>
