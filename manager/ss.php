...
<body>
   ...
   <div id="top">
      ...
      <tr><td width="20%"><img width="100%" height="100%" src="picture/b.jpeg"/></td><td><h1 style="text-align:center ">Walya BUS ONLINE TICKET RESERVATION SYSTEM</h1>	</td>
			<td>		
...
<?php
								...
								$user_query=mysql_query("select *  from manageracc where manager_id='$id_session'")or die(mysql_error());
...
<div id="admin">
        ...
        <div id="lmain">
                ...
                <div id="leftmanu">
                    ...
                    <div>
                     ...
                     <div>
                    	<a href="main.php?tag=chpass" class="customer" title="changepass">&nbsp;change password</a>
                    </div>
    ...
    <div id="rmain">
		...
		<td>
		<h3 align="left" style="color:green">WELCOME TO MANAGER SITE</h3>
		</td>
		</tr>
		</table>
             </div><!--end of pic_manu -->
         ...
         <div id="menu2">
                ...
                <!--ul>
                <li id="li_submenu"><a href="main.php?tag=clerk" class="stocks">crerate</a></li>
				</ul-->
                ...
                <li id="li_menu"><a href="#">Report</a>
                    <ul>
                        ...
                        <li id="li_submenu">
                        <a href="main.php?tag=manager" class="sales">Manager</a></li>
						<li id="li_submenu">
				...
				<li id="li_menu"><a href="#">compaccount</a>
                    <ul>
                        <li id="li_submenu">
                        <a href="main.php?tag=view_account" class="sales">View account</a></li>
                        
                    </ul>
                </li>
				<!--li id="li_menu"><a href="#">download</a>
                    <ul>
                        <li id="li_submenu">
