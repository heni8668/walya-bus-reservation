...
<form action="book1.php" method="post"  name="contactForm" target="iframe1" onSubmit = "return validate()">
        ...
        <tr><td colspan="2" align="center" style="color: black;"><b>PLEASE FILL YOUR DETAIL HERE !!!</b></td></tr>
        <tr>
	        <td align=right style="color:black"><label for="name">Departure City:</label></td>
            <td align=left><?php
	        ...
	        <td align=right style="color:black"><label for="name">Destination City:</label></td>
            <td align=left><?php
	        ...
	        <td align=right style="color:black"><label for="name">Departure Date:</label></td>
            <td align=left><?php
						if(isset($_POST['doj']))
						{
			...
			<tr>
	        <td align=right style="color:black"><label for="name">Bus SNo.:</label></td>
            <td align=left><?php
...
<?php } ?></td></tr>
			...
			<tr>
	        <td align=right style="color:black"><label for="name">Seat No.:</label></td>
            <td align=left><?php 
						for($i=1; $i<50; $i++)
						{
							$chparam = "ch" . strval($i);
	        ...
	        <td align=right style="color:black"><label for="name">price:</label></td>
            <td align=left><?php
								include('conection/connect.php');
								$depcity=$_POST['depcity'];
								$descity=$_POST['descity'];
...
<?php } ?></td></tr>
            ...
            <tr>
	        <td align=right style="color:black"><label for="name">First Name:</label></td>
			...
			<tr>
			<td align=right style="color:black"><label for="name">Last Name:</label></td>
		    ...
		    <tr>
	        <td align=right style="color:black"><label for="name">PhoneNo:</label></td>
            ...
            <tr>
	        <td align=right style="color:black"><label>Age:</label></td>
